...
const About = () => {
  ...
  return (
      ...
      <h3 style={{textAlign:"center",padding:'5px'}}>{getLang === 'বাং' ? "আমরা আপনার খাবার এবং থাকার নিশ্চিয়তা প্রদান করছি । আমাদের সাথে যুক্ত হয়ে জীবনকে সহজতর করে তুলুন" : "We will ensure your food and accommodation.Join us and make your life easier and healthy"}</h3>
