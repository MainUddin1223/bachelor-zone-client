...
const [confirmLoading, setConfirmLoading] = useState(false);
  ...
  return (
      <div className={Styles.container}>
          <h3 className={Styles.order_header}>{getLang === 'বাং' ?"খাবার অর্ডার করুন": "Order your meals"}</h3>
        ...
        <div className={Styles.lunch_container}>
          <Row gutter={[15,15]} justify={'space-between'} >
            ...
            <Col xs={12} md={6}>
              ...
              <Button type='primary' onClick={()=>setOpen(true)}>{getLang === 'বাং' ?"অর্ডার করুন": "Order Meal"}</Button>
              </div>
        </div>
    </div>
  )
